namespace HomeWorkWeek1.Models
{
	public static class RepositoryHelper
	{
		...
		public static vwClientRepository GetvwClientRepository()
		{
			var repository = new vwClientRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static vwClientRepository GetvwClientRepository(IUnitOfWork unitOfWork)
		{
			var repository = new vwClientRepository();
